...
const Resume = () => {
  return (
    <section
      className="flex flex-col md:flex-row bg-secondary text-white px-5 py-7 "
      id="resume"
    >
      ...
      <div className="md:w-1/2 flex flex-col items-center justify-center ">
        <h1 className="text-4xl mb-10 font-bold border-b-4 border-primary-border ">
          RESUME
        </h1>
        <p className="text-2xl text-center leading-10  ">
          You can view my Resume{" "}
          <a className="btn" href={ResumePdf} download="ResumePdf">
            Download
          </a>
        </p>
      </div>
