...
const Contact = () => {
  ...
  return (
   <section className='h-80 flex flex-col items-center  bg-secondary contact px-3' id='contact'>
        <h1 className='text-3xl text-white font-bold border-b-4 border-primary-border pt-16 '>CONTACT</h1>
